  ...
  <div class="service-process">
        <div class="process-item yellow-bg">
          ...
          <div class="yellowBoxImag">
            <img
              src="/patient-receives-some-good-news.jpg"
              alt="門診紀錄"
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div class="answer-container">
              <div class="answer-text">
                <p class="answer-box">全面式即時回答</p>
                <p class="answer-box">專業資料來源</p>
                <p class="answer-box">建立良好衛教觀念</p>
              </div>
              <div class="answer-image">
                <img src="/Group 23.png" alt="answer" />
              </div>
            </div>
          </div>
        </div>
...
export default defineComponent({
  name: 'AboutPage',
  setup() {
    const hover = ref(false); // 定義 hover 狀態
    const navItems = ref([
      { text: '首頁', path: '/' },
...
.dialog-box {
  background-color: rgba(255, 255, 255, 0.8); /* 0.5 為 50% 透明度 */
  padding: 15px;
  border-radius: 8px;
  margin-bottom: 10px;
...
.feature-item {
  background-color: rgba(253, 144, 132, 1);
  padding: 15px 25px;
  border-radius: 8px;
  font-size: 18px;
  color: white;
